...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'awy.google.youtube' => 'getAwy_Google_YoutubeService',
    ...
    /**
     * Gets the 'awy.google.youtube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awy\GoogleApiBundle\Client\YoutubeClient A Awy\GoogleApiBundle\Client\YoutubeClient instance.
     */
    protected function getAwy_Google_YoutubeService()
    {
        return $this->services['awy.google.youtube'] = new \Awy\GoogleApiBundle\Client\YoutubeClient('hello', 'world');
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator'))));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('It is much easier to suggest solutions when you know nothing about the problem.');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AwyGoogleApiBundle' => 'Awy\\GoogleApiBundle\\AwyGoogleApiBundle',
            ),
            ...
            'kernel.secret' => 'It is much easier to suggest solutions when you know nothing about the problem.',
